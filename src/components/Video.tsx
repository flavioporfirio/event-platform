...
import { DiscordLogo, FileArrowDown, CaretRight, Lightning } from "phosphor-react";
        ...
        <div className="flex-1">
            ...
            <div className="p-8 max-w-[1100px] mx-auto">
                <div className="flex itens-start gap-16">
                    <div className="flex-1">
                        ...
                        <div className="flex itens-center gap-4 mt-6 ">
                            ...
                            alt="Imagem de perfil do github do professor Diego Fernandes" 
                            />
                ...
                <div className="gap-8 mt-28 grid grid-cols-2">
                    <a href="" className="bg-gray-700 rounded overflow-hidden flex itens-stretch gap-6 hover:bg-gray-600 transition-colors">
